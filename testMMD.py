...
x_matrix = np.loadtxt('data/mu_day3_cut.csv', delimiter=",", skiprows=1)[:100]
y_matrix = np.loadtxt('generatedData/generated-data-alibabacompletocut-100.csv', delimiter=",")
...
print("MMD result of X and Y is {result.item()}")
