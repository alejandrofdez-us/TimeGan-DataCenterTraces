...
directory_name = '/home/afdez/trazas_azure/csvs/agregados/'
ori_data = np.loadtxt(directory_name+'vm_cpu_readings_week2_aggregated_cpu_mem.csv', delimiter=",", skiprows=0)
...
for column_name in column_names:
    ...
    ax.legend()
    plt.savefig(directory_name+column_name+'_week2.png')
    plt.close()