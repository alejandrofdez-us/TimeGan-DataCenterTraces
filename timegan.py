...
def timegan (ori_data, parameters, experiment_root_directory_name
  ...
  print("valor de no: ", no)
  print("valor de seq_len: ", seq_len)
  print ("valor de dim", dim)

  ori_time, max_seq_len = extract_time(ori_data)
  print("ori_time lenght: ", len(ori_time))
  ...
  tf.compat.v1.saved_model.simple_save(sess, experiment_root_directory_name+'/models/', inputs, outputs)
