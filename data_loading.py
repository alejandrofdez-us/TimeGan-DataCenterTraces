...
def real_data_loading(data_name, seq_len):
  ...
  """
    assert data_name in ['stock', 'energy', 'google_instance_week1', 'alibaba2018']
    ...
    if data_name == 'stock':
        ...
        ori_data = np.loadtxt('data/trazas_google/week1/instance_usage_5min_sample_week1.csv', delimiter=",",
                              skiprows=0)
    elif data_name == 'alibaba2018':
        ori_data = np.loadtxt(
            '/home/afdez/DataCenter-Traces-Datasets/alibaba2018/machine_usage_days_1_to_8_grouped_300_seconds.csv',
